...
## what to submit
do not submit only github.

submit these 3 items:
1. github repository url
2. one demo proof:
   - live deployed url, or
   - short recording video
3. mention sample generated notes path: `knowledge/notes`

## inmail template
hi <name>,  
i completed the mini agentic ai system assignment.

deliverables:
1. github: <repo link>
2. demo: <live url or short recording link>
3. sample markdown notes: `knowledge/notes` in the repo

implemented:
- master agent plus 5 specialist agents
- local markdown compiled knowledge workflow with linked topics
- black and white responsive ui with live agent activity animation
- free and low cost fallback chain across google gemini openrouter groq and euron
